if syn or KRNL_LOADED or KRNL then
    ...
    function library.new(library_title, cfg_location)
        ...
        uis.InputBegan:Connect(function(key)
            if key.KeyCode ~= Enum.KeyCode.RightControl then return end
        ...
        menu = library.new([[Fallen.CC <font color="rgb(78, 93, 234)">v2.10</font>]], "nemv2\\")
        local tabs = {
        ...
        do
            ...
            local extra = world.new_sector("Extra", "Right")
            extra.element("Toggle", "Node"):add_color({Color = Color3.fromRGB(255, 255, 255)})
    ...
    if menu.values[3].world.Extra["Node"].Toggle then
        if State then
             task.wait() do 
                for __,v in pairs(game.workspace.Resources.Nodes:GetDescendants()) do
                 if v.Name == "SulfurNode" then
                   ...
                   b.BorderSizePixel = 0
                   b.BackgroundColor3 = menu.values[3].world.Extra["Node"].Color
